...
const GAP_SIZE_BASE = isMobile ? 210 : 170;
const GAP_SIZE_MIN = isMobile ? 185 : 150;
const OBSTACLE_SPEED_INITIAL = isMobile ? 2.5 : 3.5;
const OBSTACLE_SPEED_MAX = isMobile ? 5.0 : 7.0;
